...
- **Start screen**  
  ![Start Screen](/docs/screenshots/Screenshot%202025-12-02%20025548.png "Start Screen")

- **In‑sim: drones scanning and detecting**  
  ![In Simulation](/docs/screenshots/Screenshot%202025-12-02%20025653.png "In Simulation")

- **Incident dispatch and suppression ring**  
  ![Dispatch/Detect](/docs/screenshots/Screenshot%202025-12-02%20031355.png "Dispatch/Detect")

- **Summary dashboard (post‑run)**  
  ![Summary](/docs/screenshots/Screenshot%202025-12-02%20025755.png "Summary Dashboard")
